...
WebUI.click(findTestObject('Object Repository/Page_Laravel App/div_Password wajib diisi'))

WebUI.verifyElementPresent(findTestObject('Page_Laravel App/div_Password wajib diisi'), 0)
